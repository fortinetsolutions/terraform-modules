...
![VPC network peering page](https://github.com/fortinetsolutions/terraform-modules/qwiklabs/vpc-peering/img/VPC_network_peering.png)

2. Click on "Create Peering Connection"
![VPC network peering create](https://github.com/fortinetsolutions/terraform-modules/qwiklabs/vpc-peering/img/create_peering_connection.png)
...
9. Click Create.
![VPC network peering details](https://github.com/fortinetsolutions/terraform-modules/GCP/qwiklabs/vpc-peering/img/vpc_peering_details_1.png)
...
12. Click Create.
![VPC network peering details](https://github.com/fortinetsolutions/terraform-modules/GCP/qwiklabs/vpc-peering/img/vpc_peering_details_2.png)

Within couple of seconds you will notice Status change to "Active" with Green Tick Icon, and routes being exchanged.
![VPC network peering status](https://github.com/fortinetsolutions/terraform-modules/GCP/qwiklabs/vpc-peering/img/vpc_peering_active.png)
...
4. Click "OK"
![FGT Static Route](https://github.com/fortinetsolutions/terraform-modules/GCP/qwiklabs/vpc-peering/img/fgt_static_route.png)
...
```
![FGT Static Route](https://github.com/fortinetsolutions/terraform-modules/GCP/qwiklabs/vpc-peering/img/fgt_routing_table)
...
```
![FGT Static Route](https://github.com/fortinetsolutions/terraform-modules/GCP/qwiklabs/vpc-peering/img/fgt_ping.png)
