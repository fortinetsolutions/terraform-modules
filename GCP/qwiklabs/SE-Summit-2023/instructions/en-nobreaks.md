...
* Login by scrolling down to the Google Console Details section.  Make note of the Password and click **Fleet Console**
    ...
    ![console1](https://raw.githubusercontent.com/fortidg/markdown-test/main/images/qwiklabs-info-page1.png)
...
* In the center of the screen, click  on **ROUTES** and then click **ADD ROUTE**.
    ...
    ![console19](https://raw.githubusercontent.com/fortidg/markdown-test/main/images/trust-route-add.png)
