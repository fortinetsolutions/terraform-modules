...
output "fgt_ha_cluster_ip" {
  value = length(google_compute_instance.active_instance.network_interface.0.access_config) != 0 ? google_compute_instance.active_instance.network_interface.0.access_config.0.nat_ip : google_compute_instance.passive_instance.network_interface.0.access_config.0.nat_ip
}
