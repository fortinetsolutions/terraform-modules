...
variable "private1_tgw_subnet_cidr" {
    description = "CIDR for the Private TGW Subnet 1"
}

variable "private1_tgw_description" {
    description = "Description Private TGW Subnet 1 TAG"
}

variable "private2_tgw_subnet_cidr" {
    description = "CIDR for the Private TGW Subnet 2"
}

variable "private2_tgw_description" {
    description = "Description Private TGW Subnet 2 TAG"
}
