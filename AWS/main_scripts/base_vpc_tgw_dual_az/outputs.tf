...
output "private1_tgw_subnet_id" {
  value = module.private1-subnet.id
    description = "The TGW Subnet Id of the newly created TGW Private 1 Subnet"
}
...
output "private2_tgw_subnet_id" {
  value = module.private2-subnet.id
  description = "The TGW Subnet Id of the newly created TGW Private 2 Subnet"
}
...
output "private2_tgw_route_table_id" {
  value = module.private2_tgw_route_table.id
  description = "Id of the VPC Private 2 TGW Route Table"
}
